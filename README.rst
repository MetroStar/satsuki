...
.. image:: https://img.shields.io/github/license/MetroStar/satsuki.svg
    :target: ./LICENSE
    :alt: License
.. image:: https://travis-ci.org/MetroStar/satsuki.svg?branch=master
    :target: http://travis-ci.org/MetroStar/satsuki
    :alt: Build Status
.. image:: https://ci.appveyor.com/api/projects/status/9f0bdlgdc9em6bqc?svg=true
    :target: https://github.com/MetroStar/satsuki
    :alt: Build Status
...
`GravityBee <https://github.com/MetroStar/gravitybee>`_.
